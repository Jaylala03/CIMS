(function ($) {
    $.fn.ImageDropdown = function (settings) {
        ...
        var selectRef = $(this);
        //Create Div Tag
        var divRef = $(this).after("<div class='customCombobox' id='custCombo" + id + "'><a><img width=38px height=36px src='none' class='imgDisplay' value='undefined'><p class='imageText'>Unknown</p></a></div>").next();
        //Create ul and li
        ...
        $(this).children().each(function ()
        {
            ...
            var htmltxt = "<li id='" + count + "'><a><img width=38px height=36px src=" + bg + " class='imgDisplay' value='" + $(this).attr("value") + "' /><p class='imageText'>" + $(this).html() + "</p></a></li>";
