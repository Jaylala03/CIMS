...
;(function($) {
	$.fn.scriptcam=function(options) {
		...
		return this.each(function() {
			...
			if (fileExists(decodeURIComponent(data.path) + '../../asset/ScriptCam/scriptcam.swf')) {
			    swfobject.embedSWF(decodeURIComponent(data.path) + '../../asset/ScriptCam/scriptcam.swf', opts.id, newWidth, newHeight, '11.6', false, opts, params);
			}
			else {
